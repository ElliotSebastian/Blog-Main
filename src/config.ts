...
export const siteConfig: SiteConfig = {
	title: "Crosant et Stylo",
	subtitle: "Thoughts Works and Words",
	siteURL: "https://blog.elliotsebastian.site/", // 请替换为你的站点URL，以斜杠结尾
	...
	bilibili: {
		vmid: "171688072", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		homeText: {
			...
			title: "Crosant et Stylo", // 主页横幅主标题

			subtitle: ["Blog of Elliot Sebastian", "Thoughts Works and Words"],
			typewriter: {
	...
	links: [
		...
		// 支持自定义导航栏链接，支持多级菜单
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/ElliotSebastian",
					external: true,
					icon: "fa7-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/171688072",
					external: true,
					icon: "fa7-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/elliotsebastian",
					external: true,
					icon: "mdi:git",
				},
			],
